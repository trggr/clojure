...
(with-data ds (view (time-series-plot (to-millis :Date) :Weight)))

(map string-to-date ($ :Date ds))
(with-data ds (view (time-series-plot (map string-to-date ($ :Date ds)) :Weight)))
